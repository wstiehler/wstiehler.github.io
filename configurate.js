...
let configurationMetade = new Config();
...
let configurationComplete = new Config();
...
console.groupEnd();
console.log("%c----------------------------------------", "color: red; font-size: 20px;");
$("body").append($("<p>", { text: "Criando esse paragrafo com jquery" }));
